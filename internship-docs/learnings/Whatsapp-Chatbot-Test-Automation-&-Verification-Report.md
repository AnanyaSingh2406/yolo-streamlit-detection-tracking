...
*Figure 2: Test 1 Smart Ingestion (Part B)* ### Test 2: The Trick Test (Out-of-bounds questions)
...
*Figure 3: Test 2 Out-of-bounds suppression* ### Test 3: The Multi-Task Test (Handling busy traffic)
...
*Figure 6: Test 3 Multitask Device 3* ### Test 4: The Speed and Memory Test (Following pronouns)
...
*Figure 7: Test 4 Context and memory tracking* ### Test 5: The Content Knowledge Test (Specific Terms)
...
*Figure 8: Test 5 Product domain explanation* ### Test 6: The Security Attack Test (Jailbreak attempt)
